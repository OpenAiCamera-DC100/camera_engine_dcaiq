...
#include "../algos/adebayer/rk_aiq_types_algo_adebayer.h"
...
#include "../algos/ahdr/rk_aiq_types_ahdr_algo_int.h"
#include "../algos/ahdr/rk_aiq_types_ahdr_algo.h"
#include "../algos/awdr/rk_aiq_types_awdr_algo_int.h"
...
#include "../algos/agic/rk_aiq_types_algo_agic.h"
...
#include "../algos/af/rk_aiq_af_hw_v200.h"
#else
...
//CMOS fix rk_aiq_rotation_t -> dc_aiq_rotation_t
...
typedef enum rk_aiq_cpsls_e {
    DC_AIQ_CPSLS_INVALID = -1,
    DC_AIQ_CPSLS_LED = 1,
    DC_AIQ_CPSLS_IR  = 2,
    DC_AIQ_CPSLS_MIX = 3, /*< led and ir mixture */
    DC_AIQ_CPSLS_MAX
} dc_aiq_cpsls_t;
//CMOS fix rk_aiq_cpsls_t -> dc_aiq_cpsls_t
...
//CMOS fix rk_aiq_cpsl_cfg_t -> dc_aiq_cpsl_cfg_t
...
typedef struct rk_aiq_cpsl_cap_s {
    int32_t supported_modes[DC_AIQ_OP_MODE_MAX];
    uint8_t modes_num;
    int32_t supported_lght_src[DC_AIQ_CPSLS_MAX];
...
{
    int working_mode;//values look up in dc_aiq_working_mode_t definiton
    int raw_width;
    int raw_height;
