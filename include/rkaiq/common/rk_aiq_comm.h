...
typedef enum RKAiqOPMode_e {
    DC_AIQ_OP_MODE_INVALID           = 0,                   /**< initialization value */
    DC_AIQ_OP_MODE_AUTO               = 1,                   /**< instance is created, but not initialized */
    DC_AIQ_OP_MODE_MANUAL             = 2,                   /**< instance is confiured (ready to start) or stopped */
    DC_AIQ_OP_MODE_MAX                                      /**< max */
} DCAiqOPMode_t;
//CMOS_fix RKAiqOPMode_t -> DCAiqOPMode_t
...
//CMOS fix rk_aiq_working_mode_t -> dc_aiq_working_mode_t

typedef enum {
    RK_AIQ_ISP_HDR_MODE_2_FRAME_HDR = DC_AIQ_WORKING_MODE_ISP_HDR2 + 1,
    RK_AIQ_ISP_HDR_MODE_2_LINE_HDR = DC_AIQ_WORKING_MODE_ISP_HDR2 + 2,
    RK_AIQ_ISP_HDR_MODE_3_FRAME_HDR = DC_AIQ_WORKING_MODE_ISP_HDR3 + 1,
    RK_AIQ_ISP_HDR_MODE_3_LINE_HDR = DC_AIQ_WORKING_MODE_ISP_HDR3 + 2,
...
//CMOS fix rk_aiq_module_id_t -> dc_aiq_module_id_t
